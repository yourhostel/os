...
- `Vagrant` автоматично розгортає віртуальну машину `Ubuntu 22.04`,
- Створений скрипт-провіжинг(`provision.sh`) підключений до `Vagrant`, встановлює необхідні пакети, середовище `Python` та `Flask`-додаток, і запускає його без ручного втручання.
