...
- Bash Conditional structures `if else`

[docs](https://docs.rockylinux.org/10/books/learning_bash/06-conditional-structures/)
...
### Мережеві сценарії для адміністраторів:
